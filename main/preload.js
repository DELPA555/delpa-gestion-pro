...
const CHANNELS = [
  ...
  'dashboard:weekComparison', 'dashboard:heatmap', 'dashboard:monthlyProfit', 'dashboard:localSalesPeriod',
  ...
  'cashbox:current', 'cashbox:currentAll', 'cashbox:todaySummary',
  'cashbox:open', 'cashbox:close', 'cashbox:history', 'cashbox:summary',
  'cashbox:movements', 'cashbox:addMovement', 'cashbox:report',
  'maincashbox:balance', 'maincashbox:movements', 'maincashbox:addMovement',
  'maincashbox:transfer', 'maincashbox:audit', 'maincashbox:audits',
  'maincashbox:open', 'maincashbox:close', 'maincashbox:sessions',
