...
import {
  ...
  Truck, ShoppingBag, Wallet, Receipt, BarChart3, FileText, Shield, Settings, ClipboardList, Store, ClipboardCheck, LogOut, HandCoins, PackagePlus, FileBox, PackageMinus, Boxes, Tag, PackageCheck,
} from 'lucide-react'
...
const NAV_ADMIN = [
  ...
  { to: '/reposicion',   label: 'Ped. Proveedores', Icon: Boxes },
  { to: '/vales',        label: 'Vales Desc.',      Icon: Tag },
  { to: '/consignacion', label: 'Consignación',     Icon: PackageCheck },
  ...
  return (
    <aside className="flex flex-col w-52 h-full shrink-0 bg-gradient-to-b from-[#0d0d0d] to-[#070707] border-r border-border">
      ...
      <div className="p-3 border-t border-border space-y-1">
        ...
        <div className="text-[10px] text-zinc-700">v1.12.0 · DELPA</div>
      </div>
    </aside>
  )
}
